                        ...
                        <div class="form-group">
                            ...
                            <div class="footer">
                                <div class="form-group row" style="margin-bottom:0px;">
                                    <div class="col-sm-12"> <label for="date" class="col-sm-5 col-form-label"><?php echo display('invoice_discount') ?>:</label>
                                        <div class="col-sm-5"> <input type="text" onkeyup="quantity_calculate(1);" onchange="quantity_calculate(1);" id="invoice_discount" class="form-control text-right" name="invoice_discount" placeholder="0.00" />
                                            <input type="hidden" id="txfieldnum" value="{taxnumber}">
                                            <input type="hidden" name="paytype" value="1">
                                        </div>
                                    </div>
                                    <div class="col-sm-12"> <label for="date" class="col-sm-5 col-form-label"><?php echo display('total_discount') ?>:</label>
                                        <div class="col-sm-5"> <input type="text" id="total_discount_ammount" class="form-control text-right" name="total_discount" value="0.00" readonly="readonly" /></div>
                                    </div>
                                </div>
                                <div class="form-group row hiddenRow" style="margin-bottom:0px;" id="taxdetails">
                                    ...
                                    foreach ($taxes as $taxfldt) { ?>
                                        ...
                                        <div class="col-sm-12"> <label for="date" class="col-sm-5 col-form-label"><?php echo $taxfldt['tax_name'] ?>:</label>
                                            <div class="col-sm-5"> <input id="total_tax_ammount<?php echo $x; ?>" tabindex="-1" class="form-control text-right valid totalTax" name="total_tax<?php echo $x; ?>" value="0.00" readonly="readonly" aria-invalid="false" type="text">
                                ...
                                <div class="form-group row" style="margin-bottom:0px;">
                                    ...
                                    <div class="col-sm-12"> <label for="date" class="col-sm-5 col-form-label"><?php echo display('total_tax') ?>:</label>
                                        <div class="col-sm-5"> <input id="total_tax_amount" tabindex="-1" class="form-control text-right valid" name="total_tax" value="0.00" readonly="readonly" aria-invalid="false" type="text">
                                    ...
                                    <div class="col-sm-12"> <label for="date" class="col-sm-5 col-form-label"><?php echo 'Shipping Cost' ?>:</label>
                                        <div class="col-sm-5"> <input type="text" id="shipping_cost" class="form-control text-right" name="shipping_cost" onkeyup="quantity_calculate(1);" onchange="quantity_calculate(1);" placeholder="0.00" /></div>
                                    </div>

                                </div>
                                <div class="form-group row" style="margin-bottom:0px;">
                                    <div class="col-sm-12"> <label for="date" class="col-sm-5 col-form-label"><?php echo display('grand_total') ?>:</label>
                                        <div class="col-sm-5"> <input type="text" id="grandTotal" class="form-control text-right" name="grand_total_price" value="0.00" readonly="readonly" /></div>
                                    </div>
                                    <div class="col-sm-12"> <label for="date" class="col-sm-5 col-form-label"><?php echo display('previous'); ?>:</label>
                                        <div class="col-sm-5"> <input type="text" id="previous" class="form-control text-right" name="previous" value="0.00" readonly="readonly" /></div>
                                    </div>

                                </div>
                                <div class="form-group row" style="margin-bottom:0px;">
                                    <div class="col-sm-12"> <label for="date" class="col-sm-5 col-form-label"><?php echo display('net_total'); ?>:</label>
                                        <div class="col-sm-5"> <input type="text" id="n_total" class="form-control text-right" name="n_total" value="0" readonly="readonly" placeholder="" />
                                            <input type="hidden" name="baseUrl" class="baseUrl" value="<?php echo base_url(); ?>" id="baseurl" />
                                        </div>
                                    </div>
                                    <div class="col-sm-12"> <label for="date" class="col-sm-5 col-form-label"><?php echo display('paid_ammount') ?>:</label>
                                        <div class="col-sm-5"> <input type="text" id="paidAmount"
                                                onkeyup="invoice_paidamount();" class="form-control text-right" name="paid_amount" placeholder="0.00" tabindex="13" /></div>
                                    </div>

                                </div>
                                <div class="form-group row" style="margin-bottom:0px;">
                                    <div class="col-sm-12"> <label for="date" class="col-sm-5 col-form-label"><?php echo display('due') ?>:</label>
                                        <div class="col-sm-5"> <input type="text" id="dueAmmount" class="form-control text-right" name="due_amount" value="0.00" readonly="readonly" /></div>
                                    </div>
