...
class Auth_model extends CI_Model
{
    ...
    {
        return $this->db->select('a.*, b.*, a.logo as image, CONCAT_WS(" ", a.first_name, a.last_name) AS fullname, IF(b.user_type = 1, "Admin", "User") AS user_level,d.type')
            ->from('users a')
            ->join('user_login b', 'b.user_id = a.user_id')
            ->join('sec_userrole c', 'c.user_id = a.user_id COLLATE utf8_general_ci', 'left', false) // false prevents escape
