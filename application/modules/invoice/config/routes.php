...
$route['invoice_pad_print/(:any)'] = 'invoice/invoice/bdtask_invoice_pad_print/$1';
$route['pos_print/(:any)']    = 'invoice/invoice/bdtask_invoice_pos_print/$1';
$route['invoice_pos_print']    = 'invoice/invoice/bdtask_pos_print_direct';
$route['download_invoice/(:any)']  = 'invoice/invoice/bdtask_download_invoice/$1';
$route['invoice_edit/(:any)'] = 'invoice/invoice/bdtask_edit_invoice/$1';
