                    ...
                    <div class="col-sm-6" id="payment_from_1">
                        <div class="form-group row">
                            <label for="product_name"
                                class="col-sm-3 col-form-label">Employee
                            ...
                            <input type="hidden" tabindex="4" class="form-control" name="empid" value="<?php echo $type ?>" value="123">
                        </div>
                    </div>
...
<script>
    ...
    $(document).ready(function() {
        // Fetch the selected employee ID from the backend (assuming it's available in your script)
        const selectedEmployeeId = '<?php echo $employee_id; ?>'; // This should be set from the backend
        ...
        $.ajax({
            ...
            success: function(data1) {
                ...
                $.each(employees, function(index, employee) {
                    ...
                    // Set the option as selected if it matches the selectedEmployeeId
